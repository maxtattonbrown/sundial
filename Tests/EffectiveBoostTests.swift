...
final class EffectiveBoostTests: XCTestCase {
    ...
    func test_returnsSliderValueWhenSolarUnavailable() {
        ...
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 2.5, irradiance: 800, solarAvailable: false),
            2.5
        )
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 4.0, irradiance: 0, solarAvailable: false),
            4.0
        )
    }
    ...
    func test_atFloorIrradianceReturnsFloor() {
        ...
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 2.5, irradiance: 200, solarAvailable: true),
            1.5,
            accuracy: 0.001
        )
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 2.5, irradiance: 0, solarAvailable: true),
            1.5,
            accuracy: 0.001
        )
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 4.0, irradiance: 50, solarAvailable: true),
            1.5,
            accuracy: 0.001
        )
    }
    ...
    func test_atCeilingIrradianceReturnsSlider() {
        ...
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 2.5, irradiance: 1000, solarAvailable: true),
            2.5,
            accuracy: 0.001
        )
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 4.0, irradiance: 1500, solarAvailable: true),
            4.0,
            accuracy: 0.001
        )
    }
    ...
    func test_midRangeIsHalfwayBetweenFloorAndSlider() {
        ...
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 2.5, irradiance: 600, solarAvailable: true),
            2.0,
            accuracy: 0.001
        )
        // Slider 4.0 → effective = 1.5 + 0.5 × (4.0 − 1.5) = 2.75
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 4.0, irradiance: 600, solarAvailable: true),
            2.75,
            accuracy: 0.001
        )
    }
    ...
    func test_threeQuartersWayUp() {
        ...
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 2.5, irradiance: 800, solarAvailable: true),
            2.25,
            accuracy: 0.001
        )
    }
    ...
    func test_sliderBelowFloorJustReturnsFloor() {
        ...
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 1.0, irradiance: 1000, solarAvailable: true),
            1.5,
            accuracy: 0.001
        )
    }
    ...
    func test_sliderAtFloorMeansNoVariability() {
        ...
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 1.5, irradiance: 200, solarAvailable: true),
            1.5,
            accuracy: 0.001
        )
        XCTAssertEqual(
            SundialManager.computeEffectiveBoost(slider: 1.5, irradiance: 1000, solarAvailable: true),
            1.5,
            accuracy: 0.001
        )
    }
